...
@SpringBootTest
public class CharacterOperateTest {
    ...
    @Test
    public void copyFileShouldBeSucceed() throws IOException {
        CharacterOperate co = new CharacterOperate();
        co.copyFileWithChar(source, destination);
    ...
    @Test
    public void copyFileWithCharArrayShouldBeSucceed() throws IOException {
        CharacterOperate co = new CharacterOperate();
        co.copyFileWithCharArray(source, destination);
